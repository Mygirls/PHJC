...
//        NSLog(@"centerX : %.2f, centerY : %.2f", self.center.x, self.center.y);
...
-(CAShapeLayer *)firstWaveLayer{
    if (!_firstWaveLayer) {
        ...
        _firstWaveLayer.fillColor = [UIColor colorWithRed:1.00 green:0.93 blue:0.45 alpha:1.00].CGColor;
    }
...
-(CAShapeLayer *)secondWaveLayer{
    if (!_secondWaveLayer) {
        ...
        _secondWaveLayer.fillColor = [UIColor colorWithRed:1.00 green:0.93 blue:0.45 alpha:1.00].CGColor;
    }
