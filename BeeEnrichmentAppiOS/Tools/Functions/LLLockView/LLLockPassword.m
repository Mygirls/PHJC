...
+ (NSString*)loadLockPassword
{
    ...
    NSString* pswd = [ud objectForKey:[CMCore get_user_info_member][@"mobilePhone"] ? [CMCore get_user_info_member][@"mobilePhone"] : @""];
//        LLLog(@"pswd = %@", pswd);
    if (pswd != nil &&
...
{
    [[NSUserDefaults standardUserDefaults] setObject:pswd forKey:[CMCore get_user_info_member][@"mobilePhone"]];
