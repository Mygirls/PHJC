...
@protocol  AHKActionSheetDelegate <NSObject>

- (void)get_clicked_cell_index:(NSInteger)index;

@end
/// A block-based alternative to the `UIAlertView`.
@interface AHKActionSheet : UIView <UIAppearanceContainer>
@property (nonatomic, assign)id<AHKActionSheetDelegate>delegate;
 ...
 */
@property (nonatomic, copy) NSString *selected_str;
