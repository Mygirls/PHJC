...
- (void)setTitleColor:(UIColor *)titleColor {
    ...
    for (UILabel *label in self.ccpScrollView.subviews) {
        ...
        label.textColor = [UIColor colorWithHex:@"#676767"];
...
- (void)setTitleFont:(CGFloat )titleFont {
    ...
    for (UILabel *label in self.ccpScrollView.subviews) {
        ...
        label.font = [UIFont systemFontOfSize:titleFont weight:UIFontWeightThin];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    //NSLog(@"$$$$$$$$$$$%.2f",self.ccpScrollView.contentOffset.y);
    if ((int)(self.ccpScrollView.contentOffset.y/self.ccpScrollView.frame.size.height) == (self.titleArray.count )) {
