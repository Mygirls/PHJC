...
@interface SupermarketViewController () <UITableViewDelegate,UITableViewDataSource,PaymentViewDelegate>
...
#pragma mark 刷新
- (void)set_refresh {
    __weak SupermarketViewController *_self = self;
...
//- (void)creatUI{
//    AllSuperController *vc1 = [[AllSuperController alloc]init];
//    SuperViewControllerTwo *vc2 = [[SuperViewControllerTwo alloc]init];
//    SuperViewControllerThree *vc3 = [[SuperViewControllerThree alloc]init];
//    NSArray *controllers=@[vc1,vc2,vc3];
//    NSArray *titleArray =@[@"优选计划", @"散标列表", @"转让专区"];
//    MartPagingView *rcs = [[MartPagingView alloc]initWithFrame:CGRectMake(0, 20, kScreenWidth, kScreenHeight - 60) controllers:controllers titleArray:titleArray ParentController:self];
//    vc1.mart = rcs;
