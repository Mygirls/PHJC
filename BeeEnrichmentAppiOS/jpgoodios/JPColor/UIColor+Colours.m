...
- (NSString *)hexString
{
    ...
    int r = [colorArray[0] doubleValue] * 255;
    int g = [colorArray[1] doubleValue] * 255;
    int b = [colorArray[2] doubleValue] * 255;
...
+ (UIColor *)colorFromRGBAArray:(NSArray *)rgbaArray
{
    ...
    return [UIColor colorWithRed:[rgbaArray[0] doubleValue] green:[rgbaArray[1] doubleValue] blue:[rgbaArray[2] doubleValue] alpha:[rgbaArray[3] doubleValue]];
}

+ (UIColor *)colorFromRGBADictionary:(NSDictionary *)rgbaDict
{
    if (rgbaDict[@"r"] && rgbaDict[@"g"] && rgbaDict[@"b"] && rgbaDict[@"a"]) {
        return [UIColor colorWithRed:[rgbaDict[@"r"] doubleValue] green:[rgbaDict[@"g"] doubleValue] blue:[rgbaDict[@"b"] doubleValue] alpha:[rgbaDict[@"a"] doubleValue]];
    }
...
- (NSArray *)colorSchemeOfType:(ColorScheme)type
{
    ...
    float hue = [hsbArray[0] doubleValue] * 360;
    float sat = [hsbArray[1] doubleValue] * 100;
    float bright = [hsbArray[2] doubleValue] * 100;
    float alpha = [hsbArray[3] doubleValue];
